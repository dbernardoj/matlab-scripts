function [ err ] = cdiscriminantlinearfun( xtrain,ytrain,xtest,ytest )
...
waitbar(progresscount/tot_iter,h,sprintf('(%d/%d) - %3.2f%% concluido... [LDA]',progresscount,tot_iter,perc))
end