function [ err ] = dtreedeviancefun( xtrain,ytrain,xtest,ytest )
...
ClassTree_Model = ClassificationTree.fit(xtrain,ytrain,'SplitCriterion','deviance');
...
waitbar(progresscount/tot_iter,h,sprintf('(%d/%d) - %3.2f%% concluido... [DT DEVIANCE]',progresscount,tot_iter,perc))
end