function [ err ] = dtreetwoingfun( xtrain,ytrain,xtest,ytest )
...
ClassTree_Model = ClassificationTree.fit(xtrain,ytrain,'SplitCriterion','twoing');
...
waitbar(progresscount/tot_iter,h,sprintf('(%d/%d) - %3.2f%% concluido... [DT TWOING]',progresscount,tot_iter,perc))
end