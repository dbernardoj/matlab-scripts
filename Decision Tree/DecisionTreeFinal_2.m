...
elseif choice_num == 4
    me1 = sfs_newfeats_minus_esclerose;
    mn1 = sfs_newfeats_minus_neuromielite;
    ms1 = sfs_newfeats_minus_saudavel;
    sd1 = sfs_newfeats_saudavel_doente;
    sprintf('New SFS features selected')
else
    error('No choice was made');
end
...
elseif choice_num2 == 3
    ...
    sprintf('ReliefF features selected')
elseif choice_num2 == 4
    me2 = sfs_newfeats_minus_esclerose;
    mn2 = sfs_newfeats_minus_neuromielite;
    ms2 = sfs_newfeats_minus_saudavel;
    sd2 = sfs_newfeats_saudavel_doente;
    sprintf('New SFS features selected')
else
    error('No choice was made');
end
...
save(strcat('cv-results-',datastr,'_',datestr(now)),'results_minus_saudavel','results_minus_neuromielite','results_minus_esclerose','results_saudavel_doente');
%% Bar Results
%load('bar-results')
%str = {'H vs. NmO';'H vs. MSc';'NmO vs. MSc';'H vs. D'};
%bar(results_bar_acc)

%title('Classification accuracies of all data sets considering feature selection','FontSize',20);
%xlabel('Data Sets','FontSize', 15);
